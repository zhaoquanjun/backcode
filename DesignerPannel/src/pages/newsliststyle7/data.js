const data = {
  ...
  styleModel: {
    cssvars: {
      ...
      '$date-dateShow': 'block',
      '$button-hov_fontSize': ' 12px ',
      '$button-hov_fontFamily ': ' PingFang SC ',
      '$button-hov_ftColor ': 'rgba(255, 107, 0, 1) ',
      '$button-hov_fontWeight ': 'normal ',
      '$button-hov_fontStyle ': ' normal ',
      '$button-hov_textDecoration ': 'none ',
      '$button-bdColor': 'transparent',
      '$button-hov_bdColor': 'transparent',
