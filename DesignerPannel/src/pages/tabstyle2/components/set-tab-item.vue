<template>
  <div class="add-area__container">
    ...
    >
      <li
        v-for="(child, index) in childArea"
        :key="index"
        class="set-pos-item"
      ...
      >
        ...
        <div class="operate-icon__container">
          <div class="operate-icon" @click.stop="_handleEditItem(index)">
            <i class="iconfont iconicon-dash-edit"></i>
          </div>
          <div class="operate-icon" @click.stop="_handleCopyItem(child, index)">
            <i
              class="iconfont iconicon-des-copy1"
              :class="{ disabled: childArea.length == 10 }"
            ></i>
          </div>
          <div
    ...
    <div v-show="operateShow" class="add-item__section">
      ...
      <div class="add-area__btn--group">
        ...
        <div class="ym-button--primary" @click="_handleConfirm('ruleForm')">
          确定
        </div>
      </div>
