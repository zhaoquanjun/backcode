  ...
  <div class="stpanel-parcel">
    <div class="row">
      <div
        ...
        @click="uploadImg"
      >
        <div class="image-operate flex-between-center--area">
          <div @click.stop="uploadImg">更换图片</div>
...
export default {
  ...
  methods: {
    ...
    beautifyImg() {
      ...
      if (this.$refs.tuiImageEditor && this.$refs.tuiImageEditor._initImage) {
        this.$refs.tuiImageEditor._initImage()
      }
    },
    beforeClose(done) {
      this.$refs.tuiImageEditor.close()
  ...
  .upload-box {
    ...
    .image-operate {
      ...
      .line {
        ...
        width: 1px;
        height: 16px;
        background: $--usual-font-color-sub;
      }
    }
  }
}
