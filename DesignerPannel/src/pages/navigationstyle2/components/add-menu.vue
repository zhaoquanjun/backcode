<template>
  <div class="add-menu">
    ...
    <div class="menu-item">
      ...
      <el-input v-model="ruleForm.name" show-word-limit :maxlength="20"></el-input>
    </div>
    <div class="menu-item">
    ...
    <div class="menu-item icon-set">
      ...
      <div class="icon-container">
        ...
        <div v-show="!icon" class="iconfont iconicon-add" @click="_handleAddButtonIcon"></div>
        <div v-show="icon" class="minus-icon" @click="_handleMinusButtonIcon">-</div>
      </div>
    </div>
    <icon
      :icon="icon"
