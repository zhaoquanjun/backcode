<template>
  ...
  >
    <div class="flex-between-center--area" style="width: 100%;">
      ...
      ></font-size>
      <font-color v-show="!isShow" :model="model" :prefix="prefix"></font-color>
    </div>
    <div
      class="flex-between-center--area row-top__dis"
      style="width: 100%;"
    >
      <ul v-show="isShow" class="font-style">
        ...
        >
          <li>
            <font-weight :prefix="prefix" :model="model"></font-weight>
          </li>
        </el-tooltip>
        <el-tooltip
          class="item"
        ...
        >
          <li>
            <font-italic :prefix="prefix" :model="model"></font-italic>
          </li>
        </el-tooltip>
        <el-tooltip
          class="item"
        ...
        >
          <li>
            <font-underline :prefix="prefix" :model="model"></font-underline>
          </li>
        </el-tooltip>
        <el-tooltip
          class="item"
        ...
        >
          <li>
            <font-center :prefix="prefix" :model="model"></font-center>
          </li>
        </el-tooltip>
      </ul>
      <font-color v-show="isShow" :model="model" :prefix="prefix"></font-color>
