  ...
  methods: {
    _handleSetTextAlign() {
      ...
      if (oldVal != 'center') {
        const data = {}
        const oldData = {}
        this.model[this.prefix + this.curtomName] = 'center'
...
.align-section {
  .align-icon__center {
    ...
    span:first-of-type {
      width: 20px;
      height: 16px;
      background: url("~@static/images/contentAlign/content_center.png") no-repeat center
        center;
  ...
  .activeIcon {
    ...
    span:first-of-type {
      width: 20px;
      height: 16px;
      background: url("~@static/images/contentAlign/content_center_active.png") no-repeat center
        center;
      background-size: 100% 100%;
    }
  }
