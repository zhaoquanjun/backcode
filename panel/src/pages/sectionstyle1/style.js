...
import { Select, Switch, Option, InputNumber, ColorPicker, Collapse, CollapseItem, Tabs, Tooltip, Slider, Input, TabPane, Header, Container, Aside, Tree, Main, Button, Table, TableColumn, Pagination, Dialog, Carousel, Footer, Row, Col, Upload, Loading, MessageBox } from 'element-ui'
