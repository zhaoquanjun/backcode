...
export default {
  ...
  data() {
    return {
      ...
      controlName: '幻灯片控件',
      curIndex: 0,
      tabList: [tabConfig[0], tabConfig[1], tabConfig[2], tabConfig[3], tabConfig[4]],
      curStyleIndex: 0,
      fontRange: controlValueLimit.fontRange,
      sizeSetting: controlValueLimit.sizeSetting,
      effectList: controlValueLimit.effectList,
      carouselPaginationTypeList: [controlValueLimit.carouselPaginationTypeList[0], controlValueLimit.carouselPaginationTypeList[2]]
    }
  },
  methods: {
    changeTab(i) {
