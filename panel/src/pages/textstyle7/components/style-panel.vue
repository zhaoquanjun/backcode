<template>
  <el-collapse v-model="activeNames" :accordion="true">
    <el-collapse-item name="1">
      ...
      <div>
        <font-family :model="model" :prefix="prefix" :width="232">
          <span class="setting-attribute--title">字体</span>
        </font-family>
        <font-color
          class="row-top__dis"
          :width="182"
          :model="model"
          :prefix="prefix"
        ><span class="setting-attribute--title">颜色</span></font-color>
        <font-line-height
          class="row-top__dis"
          :model="model"
          :prefix="prefix"
        ...
        <div class="row-top__dis">
          <text-align-group :model="model" :prefix="prefix"></text-align-group>
        </div>
      </div>
    </el-collapse-item>
    <el-collapse-item name="2">
      ...
      <div>
        <line-height
          ...
          :prefix="'$container-'"
          name="bdWidth"
          :value-range="fontRange.doubleborderwidth"
        >
        ...
        <border-color
          ...
          :model="model"
        >
          <span class="setting-attribute--title">颜色</span></border-color>
      </div>
    </el-collapse-item>
  </el-collapse>
</template>
...
// import DoubleBorderStyle from '@comp/border/double-border-style'
...
import LineHeight from '@comp/form/form-slider-css'
...
.el-collapse /deep/ .el-collapse-item .border-style .el-color-picker--small {
  width: 100%;
}
</style>
